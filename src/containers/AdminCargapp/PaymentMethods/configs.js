...
import { deletePaymentMethod } from '../../../helpers/api/adminCalls';
...
const deleteFunction = (id) => {
  return function () {
    (deletePaymentMethod(id)
      .then((response) => {
        setTimeout(() => {
          window.location.href = window.location.protocol + '//' + window.location.host + '/admin/payment_methods/';
  ...
  switch (type) {
    ...
    case 'MultipleButtonCell':
      ...
      var function1 = function () {
        window.location.href = window.location.protocol + '//' + window.location.host + '/admin/payment_methods/edit/' + object['id'];
      }
      var function2 = function () {
        window.location.href = window.location.protocol + '//' + window.location.host + '/admin/payment_methods/show/' + object['id'];
      }
