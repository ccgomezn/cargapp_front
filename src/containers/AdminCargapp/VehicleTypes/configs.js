...
import {deleteVehicleType} from '../../../helpers/api/adminCalls';

const deleteFunction = (id) => {
    return function () {
        (deleteVehicleType(id)
            .then(() => {
                    window.location.href = window.location.protocol + '//' + window.location.host + '/admin/vehicle_types/';
    ...
    switch (type) {
        ...
        case 'MultipleButtonCell':
            ...
            var function1 = function () {
                window.location.href = window.location.protocol + '//' + window.location.host + '/admin/vehicle_types/edit/' + object['id'];
            }
