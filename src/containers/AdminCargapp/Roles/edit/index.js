...
export default class Roles extends Component {
  ...
  componentWillMount() {
    ...
    axios.get(`https://cors-anywhere.herokuapp.com/http://api.cargapp.co/api/v1/roles/`+this.props.match.params.id)
      .then((response) => {
  ...
  handlePut() {
    axios.put('https://cors-anywhere.herokuapp.com/http://api.cargapp.co/api/v1/roles/' + this.props.match.params.id,
      {
        role: {
