...
import {deleteUserPaymentMethod} from '../../../helpers/api/adminCalls';
...
const deleteFunction = (id) => {
    return function () {
        (deleteUserPaymentMethod(id)
            .then((response) => {
                setTimeout(() => {
                    window.location.href = window.location.protocol + '//' + window.location.host + '/admin/user_payment_methods/';
    ...
    switch (type) {
        ...
        case 'MultipleButtonCell':
            ...
            var function1 = function () {
                window.location.href = window.location.protocol + '//' + window.location.host + '/admin/user_payment_methods/edit/' + object['id'];
            }
            var function2 = function () {
                window.location.href = window.location.protocol + '//' + window.location.host + '/admin/user_payment_methods/show/' + object['id'];
            }
