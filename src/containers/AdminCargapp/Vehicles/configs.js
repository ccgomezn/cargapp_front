...
const columns = [
    ...
    {
        title: <IntlMessages id="antTable.title.brand"/>,
        key: 'brand',
        width: '12%',
        render: object => renderCell(object, 'TextCell', 'brand')
    },
    {
    ...
    {
        title: <IntlMessages id="antTable.title.plate"/>,
        key: 'plate',
        width: '12%',
        render: object => renderCell(object, 'TextCell', 'plate')
    },
    {
