...
import { deleteCargappAd } from '../../../helpers/api/adminCalls';
...
const deleteFunction = (id) => {
  return function () {
    (deleteCargappAd(id)
      .then((response) => {
        setTimeout(() => {
          window.location.href = window.location.protocol + '//' + window.location.host + '/admin/cargapp_ads/';
  ...
  switch (type) {
    ...
    case 'MultipleButtonCell':
      ...
      var function1 = function () {
        window.location.href = window.location.protocol + '//' + window.location.host + '/admin/cargapp_ads/edit/' + object['id'];
      }
      var function2 = function () {
        window.location.href = window.location.protocol + '//' + window.location.host + '/admin/cargapp_ads/show/' + object['id'];
      }
...
const columns = [
  ...
  {
    title: <IntlMessages id="antTable.title.price" />,
    key: 'price',
    width: '12%',
