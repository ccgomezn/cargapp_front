...
import {deleteUserLocation} from '../../../helpers/api/adminCalls';
...
const deleteFunction = (id) => {
    return function () {
        (deleteUserLocation(id)
            .then((response) => {
                setTimeout(() => {
                    window.location.href = window.location.protocol + '//' + window.location.host + '/admin/user_locations/';
    ...
    switch (type) {
        ...
        case 'MultipleButtonCell':
            ...
            var function1 = function () {
                window.location.href = window.location.protocol + '//' + window.location.host + '/admin/user_locations/edit/' + object['id'];
            };
