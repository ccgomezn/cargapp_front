...
import { deleteCompany } from '../../../helpers/api/adminCalls';

const deleteFunction = (id) => {
  return function () {
    (deleteCompany(id)
      .then((response) => {
        window.location.href = window.location.protocol + '//' + window.location.host + '/dashboard/admin/companies/';
  ...
  switch (type) {
    ...
    case 'MultipleButtonCell':
      ...
      var function1 = function () {
        window.location.href = window.location.protocol + '//' + window.location.host + '/dashboard/admin/companies/edit/' + object['id'];
      }
      var function2 = function () {
        window.location.href = window.location.protocol + '//' + window.location.host + '/dashboard/admin/companies/show/' + object['id'];
      }
...
const columns = [
  ...
  {
    title: <IntlMessages id="antTable.title.sector" />,
    key: 'code',
    width: '12%',
    render: object => renderCell(object, 'TextCell', 'sector')
  },
  {
