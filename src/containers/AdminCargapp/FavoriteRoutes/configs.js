...
const columns = [
  ...
  {
    title: <IntlMessages id="antTable.title.origin_city" />,
    key: 'origin_city',
    width: '20%',
    render: object => renderCell(object, 'TextCell', 'origin_city')
  },
  {
    title: <IntlMessages id="antTable.title.destination_city" />,
    key: 'destination_city',
    width: '20%',
    render: object => renderCell(object, 'TextCell', 'destination_city')
  },
  {
