    ...
    switch (type) {
        ...
        case 'MultipleButtonCell':
            ...
            var function1 = function () {
                window.location.href = window.location.protocol + '//' + window.location.host + '/admin/bank_accounts/edit/' + object['id'];
            };
...
const columns = [
    ...
    {
        title: <IntlMessages id="antTable.title.accountNumber"/>,
        key: 'account_number',
        width: '12%',
        render: object => renderCell(object, 'TextCell', 'account_number')
    },
    {
        title: <IntlMessages id="antTable.title.accountType"/>,
        key: 'account_type',
        width: '12%',
        render: object => renderCell(object, 'TextCell', 'account_type')
    },
    {
        title: <IntlMessages id="antTable.title.bank"/>,
        key: 'bank',
        width: '12%',
        render: object => renderCell(object, 'TextCell', 'bank')
    }, {
