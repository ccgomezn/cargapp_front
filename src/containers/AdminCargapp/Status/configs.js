...
import {deleteStatu} from '../../../helpers/api/adminCalls';
...
const deleteFunction = (id) => {
    return function () {
        (deleteStatu(id)
            .then(() => {
                setTimeout(() => {
                    window.location.href = window.location.protocol + '//' + window.location.host + '/admin/status/';
    ...
    switch (type) {
        ...
        case 'MultipleButtonCell':
            ...
            var function1 = function () {
                window.location.href = window.location.protocol + '//' + window.location.host + '/admin/status/edit/' + object['id'];
            }
            var function2 = function () {
                window.location.href = window.location.protocol + '//' + window.location.host + '/admin/status/show/' + object['id'];
            }
